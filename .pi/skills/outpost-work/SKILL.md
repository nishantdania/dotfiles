...
4. Determine the Outpost, tmux session name, model, reasoning level, repositories, clone paths, base branches, working branches, working directory, and exact prompt for remote Pi.
